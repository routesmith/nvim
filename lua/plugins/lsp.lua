...
-- Type: Plugin
-- Purpose: nvim-lspconfig is a "data only" repo, providing basic, default
...
return {
	...
	config = function()
		...
		local servers = {
			...
			clangd = {
				cmd = { "/usr/lib/llvm-19/bin/clangd" },
				flags = {
					"--background-index",
					"--clang-tidy",
					"-isystem/usr/include", -- Example, adjust as needed
					"-std=c11", -- or '-std=c++17' for C++
					"-Wall",
				},
				init_options = {
					InlayHints = {
